...
inner join dw.geo_dim g on o.postal_code::varchar(20) = g.postal_code and g.country=o.country and g.city = o.city and o.state = g.state --City Burlington doesn't have postal code
